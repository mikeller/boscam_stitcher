...
cat build_resources/install_script_template/part_0 > ${INSTALL_SCRIPT_NAME}
...
cat build_resources/install_script_template/part_1 >> ${INSTALL_SCRIPT_NAME}

cat node_host/package.json >>  ${INSTALL_SCRIPT_NAME}

cat build_resources/install_script_template/part_2 >> ${INSTALL_SCRIPT_NAME}

cat node_host/${MANIFEST_NAME} >>  ${INSTALL_SCRIPT_NAME}

cat build_resources/install_script_template/part_3 >> ${INSTALL_SCRIPT_NAME}

chmod ug+x ${INSTALL_SCRIPT_NAME}
